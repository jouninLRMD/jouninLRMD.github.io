...
kable(cbind(data.frame(
  "Evaluación" = c("Examen No.1", "Examen No.2", "Examen No.3","Examen No.4", "Trabajo", "Quices")),
  Porcentaje = c("20%", "20%", "20%", "20%", "10%", "10%"),
  Temas = c("Fundamentos de Probabilidad", " Variables aleatorias y distribuciones de probabilidad", "Distribuciones muestrales e intervalos de confianza", "Pruebas de Hipótesis", "Estadística descriptiva", "Temas relacionados a cada parcial"),
  "Semana para Evaluación" = c("Cuarta semana", "Novena semana", "Decimotercera semana", "Decimosexta semana", "Sexta semana", "Tercera, Séptima, Décima,\nDecimoquinta Semana"),
  Modalidad = c("Individual", "Individual", "Individual", "Individual", "Parejas", "Individual")),

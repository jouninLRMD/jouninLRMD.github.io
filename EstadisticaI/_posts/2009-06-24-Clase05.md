...
1.  Suponga que en un grupo de Estadística I hay un total de `$10$`
    hombres y `$7$` mujeres, de cuantas formas posibles puede el
    profesor escoger un hombre y luego una mujer para que resuelvan un
    ejercicio?
2.  Cuantos números impares de 2 dígitos pueden formarse con el conjunto
...
Suponga que en el curso de Estadística I hay un total de `$8$`
estudiantes que van a presentar un supletorio, de cuantas formas puede
organizar el profesor los estudiantes en una fila?
...
puestos de Decano, Vicedecano, Jefe del departamento de Economía y Jefe
del departamento de Administración de Empresas. Si se tiene un total de
`$25$` candidatos, de cuantas maneras se pueden llenar estos `$4$`
puestos.
...
De cuantas manera puede organizar el profesor de Estadística I a `$6$`
